...
const categories: CategoryItem[] = [
  ...
  { id: "7", name: "Services", icon: require("../assets/images/service.png") },
  {
    ...
    icon: require("../assets/images/industry.png"),
  },
  ...
  },
  {
    id: "12",
    name: "Essentials",
    icon: require("../assets/images/essential.png"),
  },
  {
    id: "13",
    name: "Education",
  ...
  },
  {
    id: "14",
    name: "Agriculture",
    icon: require("../assets/images/agriculture.png"),
  },
  {
    id: "15",
    name: "Work Overseas",
...
export default function Category() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#f9f9f9" }}>
      ...
      <View>
        <Text style={{ color: "#000000ff", marginTop: 10 }}>
          {" "}
          All of Sri Lanka
        </Text>
      </View>
